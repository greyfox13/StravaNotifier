...
public class MainActivity extends AppCompatActivity implements View.OnClickListener
{
                ...
                if(wristSelected)
                {
                    if(isHrEnabled && (antUsed && antSelected || bleUsed && bleSelected))
                    {
                        ...
                        if (!isServiceRun)
                        {
                            ...
                            startService(intent);
                            Log.d("GFX", "Start HR service");
                        }
                        else
                        {
                            stopService(new Intent(this, HrService.class));
                            isServiceRun = false;
                            Log.d("GFX", "Stop HR service");
                        }
                    }
                    else
                    {
    ...
    protected void onDestroy()
    {
        handleReset();
        stopService(new Intent(this, HrService.class));
        Log.d("GFX","Main activity destroy");
        super.onDestroy();
    }
    ...
    {
        saveSettings();
        Log.d("GFX","Main activity paused");
        super.onPause();
    }
    ...
    private final BluetoothGattCallback bleGattCallback = new BluetoothGattCallback()
    {
        ...
        {
            Log.d("GFX","onCharacChange KEY PRESSED");
        ...
        public void onServicesDiscovered (BluetoothGatt gatt, int status)
        {
            ...
            {
                Log.d("GFX","Wrist services discovered");
